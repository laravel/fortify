...
use Laravel\Fortify\Http\Responses\FailedTwoFactorEnableResponse;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    protected function registerResponseBindings()
    {
        ...
        $this->app->singleton(FailedTwoFactorEnableResponseContract::class, FailedTwoFactorEnableResponse::class);
