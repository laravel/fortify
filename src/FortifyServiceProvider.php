...
use Laravel\Fortify\Http\Responses\ProfileInformationUpdateResponse;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    protected function registerResponseBindings()
    {
        ...
        $this->app->singleton(ProfileInformationUpdateResponseContract::class, ProfileInformationUpdateResponse::class);
